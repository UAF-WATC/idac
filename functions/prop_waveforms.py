    ...
    while i < len(dispersion_files):
        ...
        while j < len(source_time_fxn_files):
            ...
            while k < len(prop_dists):
                ...
                prop_cmd = ['ModBB', '--propagation', '--input_dispersion_file', cur_dispersion_path, '--range_km', str(range_dist), '--output_waveform_file', prop_wave_path, '--source_file', cur_source_time_fxn_path, '--max_celerity', str(max_celerity)]
